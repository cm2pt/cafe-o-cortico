...
export default function CateringCallout({ lang }: { lang: Lang }) {
  return (
    <div className="rounded-3xl border border-[#e4d8cc] bg-[#f6ede4] p-6">
      ...
      <Link
        href="/contact"
        className="mt-5 inline-flex rounded-full border border-[#d8c8bb] px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#2d1d14] transition hover:border-transparent hover:bg-white"
      >
